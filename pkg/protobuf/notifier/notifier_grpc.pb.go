...
const (
	NotifierService_SendEmail_FullMethodName    = "/protobuf.NotifierService/SendEmail"
	NotifierService_SendAllEmail_FullMethodName = "/protobuf.NotifierService/SendAllEmail"
)
...
func (c *notifierServiceClient) SendAllEmail(ctx context.Context, in *SendAllEmailRequest, opts ...grpc.CallOption) (*SendAllEmailResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotifierService_SendAllEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _NotifierService_SendAllEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotifierService_SendAllEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
